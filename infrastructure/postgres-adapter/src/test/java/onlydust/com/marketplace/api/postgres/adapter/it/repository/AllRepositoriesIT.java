...
import onlydust.com.marketplace.api.postgres.adapter.repository.AuthenticatedUserReadRepository;
...
public class AllRepositoriesIT extends AbstractPostgresIT {
    ...
    @Autowired
    AuthenticatedUserReadRepository authenticatedUserReadRepository;
    @Autowired
