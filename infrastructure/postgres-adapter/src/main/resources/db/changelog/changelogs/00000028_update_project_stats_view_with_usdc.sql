...
with budget_stats as (select pb.project_id,
                             ...
                             coalesce(sum(b.remaining_amount) filter ( where b.currency = 'usdc' ),
                                      0) usdc_remaining_amount,
                             coalesce(sum(b.remaining_amount * cuq.price) filter ( where b.currency = 'usdc' ),
                             ...
                             coalesce(sum(b.remaining_amount) filter ( where b.currency = 'strk' ),
                                      0) stark_remaining_amount,
                             coalesce(sum(b.remaining_amount * cuq.price) filter ( where b.currency = 'strk' ),
                             ...
                             coalesce(sum(b.remaining_amount) filter ( where b.currency = 'lords' ),
                                      0) lords_remaining_amount,
                             coalesce(sum(b.remaining_amount * cuq.price) filter ( where b.currency = 'lords' ),
