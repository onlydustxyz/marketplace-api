...
WHERE (dataSourceIds is null or
       ...
       c.applied_on_project_ids && dataSourceIds or
  ...
  and (projectIds is null or c.contributed_on_project_ids && projectIds or (includeApplicants and c.applied_on_project_ids && projectIds))
  and (projectSlugs is null or c.contributed_on_project_slugs && projectSlugs or (includeApplicants and c.applied_on_project_slugs && projectSlugs))
