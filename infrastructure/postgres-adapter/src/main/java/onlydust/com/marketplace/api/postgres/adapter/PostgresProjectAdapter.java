    ...
    public ProjectRewardsPageView findRewards(UUID projectId, ProjectRewardView.SortBy sortBy,
        ...
        return ProjectRewardsPageView.builder().
                rewards(Page.<ProjectRewardView>builder()
                        ...
                        .totalPageNumber(PaginationHelper.calculateTotalNumberOfPage(pageSize, count))
                        .build())
                .remainingBudget(new ProjectRewardsPageView.Money(budgetStats.getRemainingAmount(), budgetStats.getCurrency().toDomain(), budgetStats.getRemainingUsdAmount()))
                .spentAmount(new ProjectRewardsPageView.Money(budgetStats.getSpentAmount(),budgetStats.getCurrency().toDomain(), budgetStats.getSpentUsdAmount()))
