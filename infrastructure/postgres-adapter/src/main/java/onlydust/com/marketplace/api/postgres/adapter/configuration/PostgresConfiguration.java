...
public class PostgresConfiguration {
    ...
    public ProjectStoragePort projectStoragePort(final ProjectRepository projectRepository,
                                                 ...
                                                 final BiApplicationDataRepository biApplicationDataRepository) {
    ...
    @Bean
    public BiContributionContributorsDataRepository biContributionContributorsDataRepository(final EntityManager entityManager) {
        return new BiContributionContributorsDataRepository(entityManager);
    }

    @Bean
    public BiPerContributorContributionDataRepository biPerContributorContributionDataRepository(final EntityManager entityManager) {
        return new BiPerContributorContributionDataRepository(entityManager);
    }
    ...
    @Bean
    public BiProjectBudgetDataRepository biProjectBudgetDataRepository(final EntityManager entityManager) {
        return new BiProjectBudgetDataRepository(entityManager);
    }

    @Bean
    public BiProjectContributionsDataRepository biProjectContributionsDataRepository(final EntityManager entityManager) {
        return new BiProjectContributionsDataRepository(entityManager);
    }
    ...
    @Bean
    public BiApplicationDataRepository biApplicationDataRepository(final EntityManager entityManager) {
        return new BiApplicationDataRepository(entityManager);
    }
    ...
    @Bean
    public PostgresRecommenderSystemV1Adapter postgresRecommenderSystemV1Adapter(final UserAnswersV1Repository userAnswersV1Repository,
