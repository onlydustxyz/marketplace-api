...
public class PostgresConfiguration {
    ...
    public PostgresGithubAdapter postgresGithubAdapter(final GithubAppInstallationRepository githubAppInstallationRepository,
                                                       ...
                                                       final GithubIssueViewEntityRepository githubIssueViewEntityRepository) {
        return new PostgresGithubAdapter(githubAppInstallationRepository, githubRepoViewEntityRepository, githubIssueViewEntityRepository);
    }
    ...
    PostgresCommitteeAdapter postgresCommitteeAdapter(final CommitteeRepository committeeRepository,
        ...
        return new PostgresCommitteeAdapter(committeeRepository, boCommitteeQueryRepository, committeeApplicationRepository,
                committeeProjectQuestionRepository, committeeProjectAnswerViewRepository, projectInfosViewRepository, committeeJuryRepository,committeeLinkViewRepository);
    }
}
