...
public class BiContributionContributorsDataRepository extends PseudoProjectionRepository {
    ...
    @Trace(operationName = "pseudo_projection.refresh", resourceName = "refresh:bi.contribution_contributors_data:contribution_uuid")
    ...
    @Trace(operationName = "pseudo_projection.refresh", resourceName = "refresh:bi.contribution_contributors_data:repo_id")
