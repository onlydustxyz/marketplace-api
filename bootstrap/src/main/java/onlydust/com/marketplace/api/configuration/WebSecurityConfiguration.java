        ...
        http
                ...
                .authorizeHttpRequests((authorize) ->
                        authorize
                                ...
                                .requestMatchers(antMatcher(HttpMethod.PATCH, "/bo/v1/project-categories/**")).hasAnyAuthority(BO_MARKETING_ADMIN.name())
                                ...
                                .requestMatchers(antMatcher(HttpMethod.GET, "/api/v1/contributions")).permitAll()
                                .requestMatchers(antMatcher(HttpMethod.GET, "/api/v1/contributions/**")).permitAll()
                                .requestMatchers(antMatcher(HttpMethod.GET, "/api/v1/projects/**")).permitAll()
                                .requestMatchers(antMatcher(HttpMethod.GET, "/api/v2/projects/**")).permitAll()
                                ...
                                .requestMatchers(antMatcher(HttpMethod.GET, "/api/v1/issues/**")).permitAll()
                                ...
                                .requestMatchers(antMatcher("/actuator/loggers")).hasAuthority(BO_TECH_ADMIN.name())
