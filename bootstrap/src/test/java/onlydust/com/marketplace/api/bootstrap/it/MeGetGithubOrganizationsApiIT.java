    ...
    void should_return_user_organizations() {
        ...
        githubWireMockServer.stubFor(WireMock.get(WireMock.urlEqualTo("/user/orgs?per_page=100&page=1"))
                ...
                .willReturn(okJson("""
                        ...
                        """)));
        githubWireMockServer.stubFor(WireMock.get(WireMock.urlEqualTo(String.format("/orgs/%s/memberships/%s", "symeo-io", "PierreOucif")))
                .withHeader("Authorization", WireMock.equalTo("Bearer " + githubPAT))
                .willReturn(okJson("""
                                {
                        ...
                        """)));
        githubWireMockServer.stubFor(WireMock.get(WireMock.urlEqualTo(String.format("/orgs/%s/memberships/%s", "onlydustxyz", "PierreOucif")))
                .withHeader("Authorization", WireMock.equalTo("Bearer " + githubPAT))
                .willReturn(okJson("""
                                {
        ...
        githubAuthorizedRepoRepository.save(new GithubAuthorizedRepoEntity(GithubAuthorizedRepoEntity.Id.builder()
                .installationId(44084003L)
                .repoId(347315291L)
                .build()));
