...
public class AbstractMarketplaceApiIT {
    ...
    protected static final String PROJECTS_GET_AVAILABLE_ISSUES_BY_ID_OR_SLUG = "/api/v1/projects/%s/available-issues";
    protected static final String PROJECTS_V2_GET_CONTRIBUTORS_BY_ID_OR_SLUG = "/api/v2/projects/%s/contributors";
    protected static final String PROJECTS_V2_GET_REWARDS_BY_ID_OR_SLUG = "/api/v2/projects/%s/rewards";
    protected static final String PROJECTS_GET_SIMILAR_PROJECTS_BY_ID_OR_SLUG = "/api/v1/projects/%s/similar-projects";
    ...
    protected static final String PROJECT_CONTRIBUTION_UNASSIGN_V2 = "/api/v2/projects/%s/contributions/%s/unassign/%s";
    ...
    protected static final String HACKATHONS_BY_SLUG_CONTRIBUTORS = "/api/v1/hackathons/slug/%s/contributors";
    ...
    protected static final String PROGRAM_UNALLOCATE = "/api/v1/programs/%s/unallocate";
    ...
    protected static final String BI_CONTRIBUTORS_ACTIVITY_GRAPH = "/api/v1/bi/contributors/%s/activity-graph";
    ...
    protected static final String POST_SEARCH = "/api/v1/search";
    protected static final String POST_SUGGEST = "/api/v1/suggest";
    ...
    @Autowired
    protected WireMockServer nearWireMockServer;
