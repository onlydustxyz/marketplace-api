...
public class RewardStatusIT extends AbstractMarketplaceApiIT {
    ...
    private static Long repo1;
    private static Long repo2;
    private static Long repo3;
    private static Long repo4;
    ...
    public void setupPendingSignup() {
        ...
        repo1 = githubHelper.createRepo("repo1").getId();
        repo2 = githubHelper.createRepo("repo2").getId();
        ...
        indexerApiWireMockServer.stubFor(WireMock.post(WireMock.urlEqualTo("/api/v1/events/on-repo-link-changed"))
                .withRequestBody(WireMock.equalToJson("""
                        ...
                        """.formatted(repo1, repo2), true, false))
        ...
        repo3 = githubHelper.createRepo("repo3").getId();
        repo4 = githubHelper.createRepo("repo4").getId();
        ...
        indexerApiWireMockServer.stubFor(WireMock.post(WireMock.urlEqualTo("/api/v1/events/on-repo-link-changed"))
                .withRequestBody(WireMock.equalToJson("""
                        ...
                        """.formatted(repo3, repo4), true, false))
                .willReturn(WireMock.noContent()));
