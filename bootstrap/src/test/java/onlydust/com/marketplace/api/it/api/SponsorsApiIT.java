...
public class SponsorsApiIT extends AbstractMarketplaceApiIT {
    ...
    class GivenMySponsor {
        ...
        void should_get_sponsor_monthly_transactions_stats() {
            ...
            // When
            client.get()
                    .uri(getApiURI(BI_STATS_FINANCIALS, Map.of("sponsorId", sponsor.id().toString())))
                    .header(HttpHeaders.AUTHORIZATION, "Bearer " + caller.jwt())
                    .exchange()
                    // Then
                    .expectStatus()
        ...
        class GivenSomeTransactions {
            ...
            void should_get_sponsor_bi_financial_stats() {
                ...
                // When
                client.get()
                        .uri(getApiURI(BI_STATS_FINANCIALS, Map.of("sponsorId", sponsor.id().toString(), "showEmpty", "false")))
                        .header(HttpHeaders.AUTHORIZATION, "Bearer " + caller.jwt())
                        .exchange()
                        // Then
                        .expectStatus()
    ...
    class GivenNotMySponsor {
        ...
        @Test
        void should_be_unauthorized_getting_sponsor_bi_financial_stats() {
            // When
            client.get()
                    .uri(getApiURI(BI_STATS_FINANCIALS, Map.of("sponsorId", sponsor.id().toString())))
                    .header(HttpHeaders.AUTHORIZATION, "Bearer " + caller.jwt())
