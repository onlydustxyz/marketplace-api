...
//                .recordFrom("https://starknet-mainnet.infura.io/v3")
        ...
        WiremockServerRegistration.builder()
                .beanName("sorobanWireMockServer")
                .stubLocation("soroban")
                .property("infrastructure.stellar.soroban.base-uri")
                .build()
                .register(context);
        ...
        WiremockServerRegistration.builder()
                .beanName("nearWireMockServer")
                .stubLocation("near")
                .property("infrastructure.near.base-uri")
                .build()
                .register(context);
