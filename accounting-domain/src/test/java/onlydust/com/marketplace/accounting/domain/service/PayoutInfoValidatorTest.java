...
class PayoutInfoValidatorTest {
    ...
    private final PayoutInfoValidator validator = new PayoutInfoValidator(ensValidator, starknetAccountAddressWalletValidator,
            evmAccountAddressWalletValidator, aptosAccountAddressWalletValidator);
    ...
    @BeforeEach
    void resetAll() {
        reset(ensValidator, starknetAccountAddressWalletValidator, evmAccountAddressWalletValidator, aptosAccountAddressWalletValidator);
