...
public class ProjectsRestApi implements ProjectsApi {
    ...
    @Override
    public ResponseEntity<Void> ungrantBudgetFromProject(UUID projectId, UngrantRequest ungrantRequest) {
        return ProjectsApi.super.ungrantBudgetFromProject(projectId, ungrantRequest);
    }
