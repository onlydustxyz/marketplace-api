...
public class PullRequestRestApi implements PullRequestsApi {
    ...
    @Override
    public ResponseEntity<Void> updatePullRequest(Long pullRequestId, PullRequestPatchRequest pullRequestPatchRequest) {
        ...
        pullRequestFacadePort.updatePullRequest(authenticatedUser.id(),
                new UpdatePullRequestCommand(GithubPullRequest.Id.of(pullRequestId), pullRequestPatchRequest.getArchived(),
