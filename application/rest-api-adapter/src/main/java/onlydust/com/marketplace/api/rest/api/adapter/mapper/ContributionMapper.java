...
import onlydust.com.marketplace.api.contract.model.GithubPullRequestReviewState;
import onlydust.com.marketplace.api.contract.model.GithubStatus;
import onlydust.com.marketplace.api.contract.model.ProjectChurnedContributorsPageItemResponseAllOfLastContribution;
...
public interface ContributionMapper {
  ...
  static ContributionPageItemResponse mapContributionPageItemResponse(ContributionView contributionView) {
    return new ContributionPageItemResponse()
        ...
        .githubPullRequestReviewState(
            Optional.ofNullable(contributionView.getPrReviewState()).map(ContributionMapper::mapGithubPullRequestReviewState).orElse(null))
  ...
  static onlydust.com.marketplace.api.contract.model.ContributionStatus mapContributionStatusToResponse(
      onlydust.com.marketplace.api.domain.model.ContributionStatus status) {
    return switch (status) {
  ...
  static ContributionDetailsResponse mapContributionDetails(ContributionDetailsView contribution) {
    return new ContributionDetailsResponse()
        ...
        .githubPullRequestReviewState(
            Optional.ofNullable(contribution.getPrReviewState()).map(ContributionMapper::mapGithubPullRequestReviewState).orElse(null))
  ...
  static ProjectChurnedContributorsPageItemResponseAllOfLastContribution mapChurnedContribution(
      ChurnedContributorView.Contribution lastContribution) {
