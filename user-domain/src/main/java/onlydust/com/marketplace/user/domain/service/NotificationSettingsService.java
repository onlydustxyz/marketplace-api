...
public class NotificationSettingsService implements NotificationSettingsPort, UserObserverPort {
    ...
    private void updateMarketingNotificationSettings(UserId userId, NotificationSettings settings) {
    ...
    public void onUserSignedUp(AuthenticatedUser user) {
        notificationSettingsStoragePort.create(user.id(), NotificationSettings.defaultSettings());
    }
}
