package com.onlydust.projectmanagement.write.hexagon.usecases;
...
import com.onlydust.projectmanagement.write.hexagon.usecases.projectcreation.CreateProjectCommand;
import com.onlydust.projectmanagement.write.hexagon.usecases.projectcreation.CreateProjectCommandHandler;
...
public class CreateProjectCommandHandlerTest {
    ...
    void should_create_project() {
        ...
        assertThat(projectRepository.projects()).containsExactly(
                new Project(
                        aProjectId,
                        "FP-TS-2"
                ));
