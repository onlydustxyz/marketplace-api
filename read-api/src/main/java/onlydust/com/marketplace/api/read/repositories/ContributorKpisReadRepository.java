...
public interface ContributorKpisReadRepository extends Repository<ContributorKpisReadEntity, Long> {
    ...
    @Query(value = """
            ...
            FROM bi.select_contributors(:fromDate, :toDate, :programOrEcosystemIds, :projectIds, :projectSlugs, :categoryIds, :languageIds, :ecosystemIds, :countryCodes, :contributorRoles, :search) d
                     LEFT JOIN (
                            select * from bi.select_contributors(:fromDatePreviousPeriod, :toDatePreviousPeriod, :programOrEcosystemIds, :projectIds, :projectSlugs, :categoryIds, :languageIds, :ecosystemIds, :countryCodes, :contributorRoles, :search)
