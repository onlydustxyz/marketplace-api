...
public interface ContributorKpisReadRepository extends Repository<ContributorKpisReadEntity, Long> {
    ...
    @Query(value = """
            ...
            FROM (SELECT c.contributor_id                                                          as contributor_id,
                         ...
                         coalesce(cd.in_progress_issue_count, 0)                                   as in_progress_issue_count,
                         coalesce(ad.pending_application_count, 0)                                 as pending_application_count,
                         ...
                         coalesce(cd.previous_period_in_progress_issue_count, 0)                   as previous_period_in_progress_issue_count,
                         coalesce(ad.previous_period_pending_application_count, 0)                 as previous_period_pending_application_count,
