...
public interface ProjectsPageV2WithOdHackStatsRepository extends JpaRepository<ProjectPageV2ItemWithOdHackQueryEntity, UUID> {
    @Query(value = """
        ...
        """, nativeQuery = true)
    Page<ProjectPageV2ItemWithOdHackQueryEntity> findHackathonProjects(String hackathonSlug,
                                                            UUID[] languageIds,
                                                            UUID[] ecosystemIds,
